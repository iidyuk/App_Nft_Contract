...
範囲:
 最小値: 0
 最大値: 2^256 - 1 (これは非常に大きな数で、約 1.15times10 77   に相当します。
地球上の原子の数よりもはるかに大きいと言われています。)
この広範な数値範囲により、トークンの残高、タイムスタンプ、ブロック番号、供給量など、
ブロックチェーンアプリケーションで必要となるほとんどの数値を表現できます。
*/
